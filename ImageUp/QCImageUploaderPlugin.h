...
#define PREF_KEY_DEFAULT_QC_IMAGE_UPLOADER	@"QC Default Image Uploader"

#import <AppKit/AppKit.h>
#import <Adium/AIPlugin.h>
#import <AIUtilities/AIWindowAdditions.h>

@class QCImageUploaderWindowController, AIChat;

@interface QCImageUploaderPlugin : AIPlugin <NSMenuDelegate> {
